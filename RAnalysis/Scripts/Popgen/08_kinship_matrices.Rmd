...
# ped
All.pedform <- pedtools::ped(id = All.pedigree.sex$id,
                                        fid = All.pedigree.sex$dam,
                                        mid = All.pedigree.sex$sire,
                                        sex = All.pedigree.sex$sex)
...
# ped
LowvMod.pedform <- pedtools::ped(id = LowvMod.pedigree.sex$id,
                                        fid = LowvMod.pedigree.sex$dam,
                                        mid = LowvMod.pedigree.sex$sire,
                                        sex = LowvMod.pedigree.sex$sex)
